...
export default function NotesHubPage() {
  ...
  const handleDownloadNote = (note: Note) => {
    toast.info('Coming soon! Notes download will be available soon.');
  };
  ...
  return (
    <MainLayout showBottomNav headerTitle="Notes" className="bg-[#0A0A0A]">
      <div className="p-4 pt-0">
        <p className="text-[#A0A0A0] text-sm mb-3">Download study materials for your class</p>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-[20px] font-medium text-sm whitespace-nowrap transition-all ${
                activeClass === cls.id
                  ...
                  : 'bg-[#1A1A1A] text-white border border-[#2A2A2A] hover:border-[#B9FF66]/50'
              }`}
            >
              {cls.label}
            </button>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between gap-2">
                              ...
                              <Button
                                size="sm"
                                className="h-8 px-3 rounded-[20px] bg-[#2A2A2A] text-[#9CA3AF] font-medium text-xs flex-shrink-0"
